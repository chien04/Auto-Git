                ...
                {students.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {students.map((student) => (
                      <div key={student.studentId} className="p-4 rounded-xl bg-white shadow-[0_8px_22px_rgba(17,19,24,0.10)] hover:shadow-[0_12px_28px_rgba(17,19,24,0.14)] transition-shadow">
    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="flex flex-col min-h-screen max-w-[420px] w-full bg-white shadow-2xl">
        ...
        {activeTab === 'chat' ? (
          ...
          <Setting vscode={vscode} user={user} />
        ) : activeTab === 'dashboard' ? (
          <>
              ...
              {classes.length === 0 ? (
                ...
                classes.map((classItem) => (
                  <div
                    ...
                    className="group relative p-5 rounded-2xl bg-white shadow-[0_8px_24px_rgba(17,19,24,0.10)] hover:shadow-[0_12px_30px_rgba(17,19,24,0.14)] transition-all cursor-pointer"
                  >
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
